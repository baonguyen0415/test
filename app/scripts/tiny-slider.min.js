var tns = (function () {
  ...
  function percentageLayout() {
    ...
    supported =
      Math.abs(wrapper.getBoundingClientRect().left - outer.children[count - perPage].getBoundingClientRect().left) < 2;
  ...
  var tns = function (options) {
    ...
    function doContainerTransform(val) {
      ...
      if (document.body.classList.contains("theme-rtl") && val.charAt(0) === "-") {
        val = val.substr(1);
      }
    ...
    function getMoveDirectionExpected() {
      return (
        getTouchDirection(toDegree(lastPosition.y - initPosition.y, lastPosition.x - initPosition.x), swipeAngle) ===
        options.axis
      );
    }
          ...
          if (carousel) {
            rafIndex = raf(function () {
              if (horizontal && !autoWidth) {
                ...
                if (document.body.classList.contains("theme-rtl")) {
                  index += indexMoved * -1;
                } else {
                  index += indexMoved;
                }
...
window.tns = tns;
console.log("tiny-slider.js loaded");
